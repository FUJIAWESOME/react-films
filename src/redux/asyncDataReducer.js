// import { getFavoriteFilmsId, getGenres } from "../Requests";
import { ADD_FAVORITE_FILM, DELETE_FAVORITE_FILM, LOAD_CREDITS, LOAD_DETAILS, LOAD_FAVORITE_LIST, LOAD_FILMS, LOAD_GENRES } from "./types";
...
export function asyncDataReducer(state = initialState, action) {
    ...
    switch (action.type) {
        ...
        case DELETE_FAVORITE_FILM: {
            return {
                ...state,
                favoriteList: [...state.favoriteList].filter(item => item !== action.id),
            }
        }
